...
export const el = {
    ...
    aiGeneralProviderBadge: $('ai-general-provider-badge'),
    aiAppleIntelligenceStatus: $('ai-apple-intelligence-status'),
    aiAppleIntelligenceMessage: $('ai-apple-intelligence-message'),
    aiGeneralEndpointField: $('ai-general-endpoint-field'),
    aiGeneralModelField: $('ai-general-model-field'),
    aiGeneralKeyField: $('ai-general-key-field'),
